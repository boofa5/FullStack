# 14.3 Lesson Plan: The Power of the ORM <!--links--> &nbsp; [⬅️](../02-Day/02-Day-LessonPlan.md) &nbsp; [➡️](../../15-Week/01-Day/01-Day-LessonPlan.md)
...
### 6. Students Do: Party Database App (20 minutes)
...
### 7. Everyone Do: Party Database App Review (10 minutes)
...
* Open up `17-MvcExample` within your file-system to show your students what the MVC framework looks like and answer whatever questions they may have regarding its usage and functionality.

### 13. Partners Do: Discussing MVC (5 minutes)
...
* Before dismissing your class, Slack out the `MySQLHerokuDeploymentProcess.pdf`. Tell them that just setting up the remote database for the first time will take a good hour or so; advise them to carve out that time from their schedules so they can submit their homework.
