## 02-Day Lesson Plan - Going Pro with HTML/CSS <!--links--> &nbsp; [⬅️](../01-Day/01-Day-LessonPlan.md) &nbsp; [➡️](../03-Day/03-Day-LessonPlan.md)
...
* Either live-code or open the solution (`Basic-HTML-Bio.html`) to the previous activity in Visual Studio Code. Then, walk students through the solution line-by-line.
