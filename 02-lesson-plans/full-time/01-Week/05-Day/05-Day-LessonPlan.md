...
* Welcome students back to class. Then open the Powerpoint [BeholdBootstrap](SlideShow/).
...
* In your demonstration, at the very least, do the following:
  ...
  * Point students to the use of _panels_ on the Bootstrap website. <http://getbootstrap.com/components/#panels>

### 17. Students Do: Bootstrap Wireframe Activity (30 min)

* Then open the file  `layout.html` (`16-PanelLayout`) in your browser. Show students what they will be building for the next activity.
