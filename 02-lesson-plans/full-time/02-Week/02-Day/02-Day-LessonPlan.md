## 02-Day Lesson Plan - Jumping for JavaScript <!--links--> &nbsp; [⬅️](../01-Day/01-Day-LessonPlan.md) &nbsp; [➡️](../03-Day/03-Day-LessonPlan.md)
...
### 4. Students Do: Another Loop (5 min)
...
### 8. Everyone Do: Browser Events (10 mins)
...
### 20. Group Do: Recap Activity (46 min, or remaining time)

* Use the remaining time to complete this weeks homework assignment.
