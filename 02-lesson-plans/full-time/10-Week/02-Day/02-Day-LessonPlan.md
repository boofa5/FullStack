## Day 02 - Intro to React, Components and JSX <!--links--> &nbsp; [⬅️](../01-Day/01-Day-LessonPlan.md) &nbsp; [➡️](../03-Day/03-Day-LessonPlan.md)
...
### 1. Instructor Do: Welcome and Encouragement

### 2. Instructor Do: Go Through Slides (10 mins)
...
### 4. Instructor Do: Review Questions (10 mins)
...
### 5. Instructor Do: Demo Create React App (14 mins)
...
### 8. Students Do: HelloDiv (10 mins)
...
* Explain to the class that the rendered elements in this example are using Bootstrap classes.
  ...
  * Without going into the component code yet, assure everyone that all of the React code is correct. Ask the class: Why then isn't my page rendering Bootstrap elements? What did I forget?
    ...
    * Open up the example in your code editor and ask the class: What should I do to if I wanted to add Bootstrap using a CDN?
      ...
      * So you don't have to go looking for it: `<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/3.3.7/css/bootstrap.min.css"/>`
...
* Explain that we are also able to add inline styles to JSX elements. Open the `Panel` component to demonstrate this.
...
### 19. Instructor Do: Go through Slides (10 mins)
...
### 20. Instructor Do: Props Demo (10 mins)
...
### 22. Instructor Do: Review Calculator Props (10 mins)
...
### 23. Partners Do: Props Review (15 mins)

* Slack out `11-Stu_PropsReview/Unsolved`
...
* Slack out `12-Stu_ComponentMap/Unsolved`
...
* Slack out `14-Stu_DecrementCounter/Unsolved`
...
* Then go over the bonus solution:
  ...
  * Point out that we've replaced the `.panel-body` div with a `PanelBody` component which renders its contents.

  * We pass the click count and the event listeners to the `PanelBody` component.

* Demonstrate the code inside of the `PanelBody` component:

  * ![Decrement Bonus Panel](Images/08-DecrementBonusPanel.png)
...
* Before dismissing class, recommend students do their best to go through the following sections of the React documentation before the next class:
