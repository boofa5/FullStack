## Day 2 - More on ASP.NET MVC and Models

### Overview

Introduce students to more intermediate techniques of ASP.NET MVC, such as model validation; formatting annotations; and LINQ queries.
