...
Student utilized constructors to create a working hangman cli game. The game uses constructor functions to create objects representing each word to guess as well as each letter in each word. The deployed assignment has been added to their deployed portfolio with a link provided in the submission.
